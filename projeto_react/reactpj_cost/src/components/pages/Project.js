...
export default function Project() {
  ...
  /* Retorna a localização do projeto com id passado */
  useEffect(() => {
    setTimeout(() => {
  ...
  function editPost(project) {
    ...
    if (project.budget < project.cost) {
      setMessage("O orçamento não pode ser menor que custo do projeto!");
      setType("error");
      return false;
    }
  ...
  function removeService(id, cost) {
    ...
    projectUpdated.cost = parseFloat(projectUpdated) - parseFloat(cost);
